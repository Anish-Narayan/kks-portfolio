      ...
      <div className="flex flex-col md:flex-row gap-8 items-center">
        <div className="flex-1">
          ...
          <p className="text-gray-300 mb-4">
            At KK’s Pixel, we build powerful digital strategies that help businesses stand out. From social media marketing and ad campaigns to content creation and brand storytelling, we focus on delivering real growth. Our goal is simple: reach the right audience, build trust, and convert engagement into revenue.
          </p>
        </div>
